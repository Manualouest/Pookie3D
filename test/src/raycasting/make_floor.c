...
/*   Updated: 2024/10/17 19:22:44 by mbirou           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	cd_put_floor(t_f_c_info *info, int type, int **texture)
{
	...
	floorx = type * info->pos_x + info->row_dst * info->dirx0;
	floory = type * info->pos_y + info->row_dst * info->diry0;
	...
	mlx_put_pixel(info->floor, info->x, info->y, color);
}
